    ...
    <React.Fragment>
      <div>
        ...
        <div>
          ...
          <div className="bottom" style={{ paddingBottom: "40px" }}>
            {" "}
            {/*Parallex important class*/}
            <p className="bottom-title p-top">
              ...
              <Fade bottom>
                <TransparentCard>
                  <span className="small-text">
                    Solace enables an event mesh with PubSub+, our advanced
                    event brokers. You create an event mesh with Solace by
                    deploying PubSub+ in any/all your environments
                    (public/private clouds, on premises), and then connecting
                    them, at which point all applications, microservices, cloud
                    services, SaaS, iPaaS and legacy systems connected to an
                    event broker in the mesh will be instantly and continuously
            ...
            <p className="bottom-title p-top-all">
            ...
            <div className="bottom-section-dark">
              ...
              <p className="bottom-title">
                The only unified and tomorrow-proof solution
              </p>
            ...
            <Fade bottom>
              ...
              <p className="small-text">
                VoiceBase is an AI-powered speech analytics company with a
                customer base that includes Twilio, AWS, and Tableau. When their
                VP of engineering, Jeff Shukis, built a prototype that simulated
                2.7 billion minutes of processing per month, “several times what
                YouTube takes in,” only PubSub+ could handle the demand.
              </p>
            </Fade>
            <Fade bottom>
              <div className="image-centering">
                <img
                  src="https://play.vidyard.com/1Fov7X3fbs4f531JyriVbh.jpg"
                  alt="Video Thumbnail"
                />
              </div>
            </Fade>
            ...
            <Fade bottom>
              <p className="bottom-title">
                Proven in the most demanding use cases
              </p>
            </Fade>
            <Fade bottom>
              <div className="image-centering">
                <img
                  src="https://play.vidyard.com/n86sLadmBwxW9hVY12Gbgi.jpg"
                  alt="Video Thumbnail"
                />
              </div>
            </Fade>
